...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=PostalAdress::class, mappedBy="user")
     */
    private $postalAdresses;
    ...
    public function addPostalAdress(PostalAdress $postalAdress): self
    {
        if (!$this->postalAdresses->contains($postalAdress)) {
            $this->postalAdresses[] = $postalAdress;
    ...
    public function removePostalAdress(PostalAdress $postalAdress): self
    {
